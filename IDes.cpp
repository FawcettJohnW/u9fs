...
Plan9::Security::IDes::IDes( void )
{
}

void Plan9::Security::IDes::block_cipher(char expanded_key[128], char text[8], int decrypting)
{
	char *key;
 ...
 *	Initial Permutation
 */
long Plan9::Security::IDes::ip_low(char block[8])
{
	int i;
	long l;
...
long Plan9::Security::IDes::ip_high(char block[8])
{
	int i;
	long l;
...
void Plan9::Security::IDes::fp(long left, long right, char text[8])
{
...
void Plan9::Security::IDes::key_setup(char key[DESKEYLEN], char *ek)
{
	int i, j, k, mask;
	uchar (*x)[2];
